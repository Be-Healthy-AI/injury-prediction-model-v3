#!/usr/bin/env python3
"""
Random Forest Training Script V4 with Temporal Split
...
def main():
    parser = argparse.ArgumentParser(description="Train Random Forest V4 with optional feature controls.")
    ...
    print("🚀 RANDOM FOREST TRAINING V4 (DUAL VALIDATION)")
    print("=" * 70)
    if args.keep_week5:
    ...
    print("=" * 70)
    val_insample_metrics, _, _ = evaluate_model(rf_model, X_val_insample, y_val_insample, "In-Sample Validation")
    ...
    print("=" * 70)
    val_outsample_metrics, _, _ = evaluate_model(rf_model, X_val_outsample, y_val_outsample, "Out-of-Sample Validation")
    ...
    model_file = 'models/rf_model_v4.joblib'
    columns_file = 'models/rf_model_v4_columns.json'
    metrics_file = 'models/rf_model_v4_metrics.json'
