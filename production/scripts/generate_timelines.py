...
Reads daily features from production/deployments/{country}/{club}/daily_features/ and generates
...
def main():
    ...
    parser.add_argument(
        ...
        type=int,
        nargs='*',
        help='Specific player IDs to process (if not provided, uses club config or processes all players with daily features)'
    )
    ...
    print(f"📂 Output directory: {timelines_dir}")
