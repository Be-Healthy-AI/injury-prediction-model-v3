#!/usr/bin/env python3
"""
Enhanced Random Forest Training Script V3 with Validation
...
def main():
    print("🚀 ENHANCED RANDOM FOREST TRAINING WITH VALIDATION")
    print("=" * 70)
    ...
    # Try V3 file first, fallback to V2 if needed
    if os.path.exists('../scripts/timelines_35day_enhanced_balanced_v3.csv'):
        df = pd.read_csv('../scripts/timelines_35day_enhanced_balanced_v3.csv')
    elif os.path.exists('timelines_35day_enhanced_balanced_v3.csv'):
        df = pd.read_csv('timelines_35day_enhanced_balanced_v3.csv')
    else:
        df = pd.read_csv('timelines_35day_enhanced_balanced.csv')  # Fallback
    ...
    cv_scores = cross_val_score(rf_model, X_train, y_train, cv=cv_skf, 
    ...
    model_file = 'models/model_v3_random_forest_validated.pkl'
    columns_file = 'models/model_v3_rf_validated_training_columns.json'
    ...
    # Save final model
    final_model_file = 'models/model_v3_random_forest_100percent.pkl'
    final_columns_file = 'models/model_v3_rf_100percent_training_columns.json'
