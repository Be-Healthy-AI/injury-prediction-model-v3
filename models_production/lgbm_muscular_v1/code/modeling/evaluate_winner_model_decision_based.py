...
# ========== CONFIGURATION ==========
WINNER_MODEL_PATH = 'models/lgbm_model_seasonal_10pc_v4_muscular_corr08.joblib'
WINNER_COLUMNS_PATH = 'models/lgbm_model_seasonal_10pc_v4_muscular_corr08_columns.json'
