# Deployment guidelines – Muscular LGBM (iteration 16)
...
- Test predictions from this training run have been exported to:
  - `models_production/lgbm_muscular_v4/test_predictions_from_training_pipeline.csv`
...
The deploy script expects non-suffixed names. In `models_production/lgbm_muscular_v4/models/` copy:
